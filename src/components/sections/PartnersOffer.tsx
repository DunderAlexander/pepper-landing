...
import PepperRedIcon from '/public/pepper-red.svg'
		...
		<OfferSection>
			<PaddedContainer>
				...
				<Flex $mobileGap='2.44rem' $desktopGap='6.25rem'>
					...
					<Flex $order={4}>
						<StepsContainer $mobileCols='max-content max-content max-content'>
							<p>{t('Review_step-1')}</p>
							<p>{t('Review_step-2')}</p>
							<p>{t('Review_step-3')}</p>
						</StepsContainer>
						<PeppersContainer>
							<PepperIconContainer>
								<Image width={25} height={25} src={'/pepper-red.png'} alt='' />
							</PepperIconContainer>
							<PepperIconContainer>
								<Image width={25} height={25} src={'/pepper-red.png'} alt='' />
							</PepperIconContainer>
